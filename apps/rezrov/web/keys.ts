...
/**
 * Whether a Play-mode keystroke should be redirected into the command box:
 * it isn't already aimed there, the box is enabled, and it's a plain key
 * (no modifier / IME composition).
 */
